...
function QwenLocalSectionEntry({ useLocale, load, save }) {
  ...
  return React.createElement('div', { style: { maxWidth: 560 } },
    ...
    React.createElement('div', null,
      ...
      React.createElement('label', { style: { display: 'flex', gap: 6, alignItems: 'center', fontSize: 13, cursor: 'pointer', marginBottom: 16 } },
        React.createElement('input', {
          type: 'checkbox',
    ...
    React.createElement('div', null,
      ...
      React.createElement(Field, { label: t.defaultEffort },
        React.createElement('select', { style: INPUT_STYLE, value: draft.defaultEffort, onChange: (e) => setDraft({ defaultEffort: e.target.value }) },
