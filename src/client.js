...
const COPY = {
  en: {
    ...
    thinkingHintNinfer: 'Per-effort thinking budgets are not supported on NInfer (upstream ninfer — unversioned source/Docker build; ninfer-windows 0.5.0).',
  ...
  zh: {
    ...
    thinkingHintNinfer: 'NInfer 不支持按 effort 的 thinking 预算（上游 ninfer 无版本号，源码/Docker 构建；ninfer-windows 0.5.0）。',
