...
var SELECT_STYLE_DARK = {
  ...INPUT_STYLE,
  background: "#26262b",
  color: "#ececec"
};
var SELECT_STYLE_LIGHT = {
  ...INPUT_STYLE,
  background: "#f4f4f4",
  color: "#111111"
};
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "select",
          { style: dark ? SELECT_STYLE_DARK : SELECT_STYLE_LIGHT, value: draft.images, onChange: (e) => setDraft({ images: e.target.value }) },
